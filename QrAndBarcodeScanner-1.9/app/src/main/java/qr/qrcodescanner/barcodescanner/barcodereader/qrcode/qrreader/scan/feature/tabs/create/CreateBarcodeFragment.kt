...
import qr.qrcodescanner.barcodescanner.barcodereader.qrcode.qrreader.scan.extension.clipboardManager
import qr.qrcodescanner.barcodescanner.barcodereader.qrcode.qrreader.scan.extension.orZero
import qr.qrcodescanner.barcodescanner.barcodereader.qrcode.qrreader.scan.feature.tabs.create.barcode.CreateBarcodeAllActivity
import qr.qrcodescanner.barcodescanner.barcodereader.qrcode.qrreader.scan.feature.tabs.create.qr.CreateQrCodeAllActivity
...
class CreateBarcodeFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        faLogEvents.logScreenViewEvent("CreateBarcodeFragment", "CreateBarcodeFragment")
    }
