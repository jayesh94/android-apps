...
import qr.qrcodescanner.barcodescanner.barcodereader.qrcode.qrreader.scan.model.schema.Bookmark
...
class CreateQrCodeBookmarkFragment : BaseCreateBarcodeFragment() {
    ...
    override fun onResume() {
        super.onResume()
        faLogEvents.logScreenViewEvent("CreateQrCodeBookmarkFragment", "CreateQrCodeBookmarkFragment")
    }
    ...
    private fun toggleCreateBarcodeButton() {
        ...
        generate_code_button.isEnabled = edit_text_title.isNotBlank() || edit_text_url.isNotBlank()
    }
}