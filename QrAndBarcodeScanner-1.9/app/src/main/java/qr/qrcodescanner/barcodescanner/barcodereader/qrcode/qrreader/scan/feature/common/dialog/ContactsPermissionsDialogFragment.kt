...
class ContactsPermissionsDialogFragment(private val permissionDeniedBefore: Boolean, private val shouldShowRequestPermission: Boolean = false) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setTitle(getString(R.string.contacts_permissions_title))
        builder.setIcon(R.drawable.ic_baseline_contacts)
    ...
    private fun setDialogWhenDenied(builder: AlertDialog.Builder, listener: Listener?): AlertDialog {
        builder.setMessage(R.string.contacts_permissions_request_permissions)
        builder.setPositiveButton(R.string.contacts_permissions_request_permissions_button_text) { _, _ -> listener?.showContactsPermissionDialog() }
    ...
    private fun setDialogWhenDontAskAgain(builder: AlertDialog.Builder): AlertDialog {
        builder.setMessage(
            getString(R.string.contacts_permissions_app_settings_l1) + "\n\n" +
                    getString(R.string.contacts_permissions_app_settings_l2) + "\n" +
                    getString(R.string.contacts_permissions_app_settings_l3) + "\n" +
                    getString(R.string.contacts_permissions_app_settings_l4)
        )
        builder.setPositiveButton(R.string.contacts_permissions_app_settings_button_text) { _, _ ->
            val intent = Intent()
...
//             positiveButton.setCompoundDrawablePadding();
    ...
    override fun onResume() {
        super.onResume()
        faLogEvents.logScreenViewEvent("ContactsPermissionsDialogFragment", "ContactsPermissionsDialogFragment")
    }
}