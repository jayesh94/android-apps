package qr.qrcodescanner.barcodescanner.barcodereader.qrcode.qrreader.scan.feature.tile
...
class QuickSettingsTileService : TileService() {
    ...
    override fun onClick() {
        ...
        val intent = Intent(applicationContext, BottomTabsActivity::class.java).apply {
            faLogEvents.logCustomButtonClickEvent("quick_tile_service_scanner_button")
