...
public class ColorSeekBar extends View {
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mBarHeight = (int) a.getDimension(R.styleable.ColorSeekBar_barHeight, (float) dp2px(30));
        mBarRadius = (int) a.getDimension(R.styleable.ColorSeekBar_barRadius, 15);
        ...
        thumbColorPaint.setColor(Color.DKGRAY);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsShowColorBar) {
            ...
            if (mShowThumb) {
                ...
                canvas.drawCircle(thumbX, thumbY, Math.round(mBarHeight/2.0) + 10, thumbColorPaint);
                canvas.drawCircle(thumbX, thumbY, Math.round(mBarHeight/2.0), colorPaint);
...
//                canvas.drawCircle(thumbX, thumbY, mThumbHeight / 2, thumbGradientPaint);
        ...
        if (mIsShowAlphaBar) {
            ...
            if (mShowThumb) {
                ...
                canvas.drawCircle(alphaThumbX, alphaThumbY, Math.round(mBarHeight/2.0) + 10, thumbColorPaint);
                canvas.drawCircle(alphaThumbX, alphaThumbY, Math.round(mBarHeight/2.0), colorPaint);
