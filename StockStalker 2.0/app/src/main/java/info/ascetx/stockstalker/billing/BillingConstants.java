...
//    public static final String SKU_PREMIUM = "android.test.purchased";
    public static final String SKU_PREMIUM = "hide.ads";
    public static final String SKU_GAS = "gas";

    // SKU for our subscription (infinite gas)
    public static final String SKU_GOLD_MONTHLY = "premium_monthly";
    public static final String SKU_GOLD_YEARLY = "premium_yearly";
